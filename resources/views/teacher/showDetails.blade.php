  ...
  <div class="row">
    <div class="col-sm-6 col-md-4">
      <div class="div-box">
        ...
        <h4 class="designation"><?php print_r($teachers->Tid); ?></h4>
        ...
        <div class="profile-details">
          <ul>
            ...
            <li><a href="#"><i class="fas fa-phone-alt"></i> <?php print_r($teachers->number); ?></a></li>
            <li><a href="#"><i class="fa fa-address-card-o"></i> <?php print_r($teachers->address); ?></a></li>
            <li><a href="#"><i class="fa fa-book></i> <?php print_r($teachers->designation); ?></a></li>
            <li><a href="#"><i class="fa fa-book></i> <?php print_r($teachers->course); ?></a></li>
          </ul>
        </div>
      </div>
    </div>
