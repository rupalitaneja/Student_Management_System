...
<div id="viewport">
  ...
  <div id="sidebar">
    ...
    <ul class="nav">
      ...
      <li>
        <a href="{{url('/viewStudentList')}}">
          <i class="zmdi zmdi-link"></i> View All students
        </a>
      </li>
      
      <li>
        <a href="{{url('/viewCourseList')}}">
...
<br>
      ...
      <p>
      <div class="image"> <img style="width:100%; vertical-align: middle; padding-top: 10%;    margin-top: -2.9%;" src="uploads/quote.jpg">  </div>
      </p>
    </div>
  </div>
</div>